    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
            ...
            >
                ...
                <h1 className="text-7xl font-extralight text-white mb-4 tracking-tight">
                    Featured Projects
                </h1>
            ...
            >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-[2px] bg-white/10" />
                ...
                {projects.map((project, index) => (
                    ...
                    >
                        ...
                        <motion.div
                            className={`inline-block w-full md:w-[48%] ${
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="absolute top-6 right-6 w-12 h-12 bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)]"
                            >
