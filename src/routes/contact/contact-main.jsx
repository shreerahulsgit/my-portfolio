    ...
    >
      ...
      <div className="fixed inset-0 z-0">
        <div className="w-full h-full">
          <Spline
            scene="https://prod.spline.design/PfL1jvAFxEh3glQs/scene.splinecode"
      ...
      <div className="relative z-20 px-6 pt-20 pb-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className={`text-xl md:text-2xl mb-8 transform transition-all duration-1000 delay-300 ease-out ${
                isLoaded
                  ? "translate-y-0 opacity-100"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.borderColor = "rgba(248, 248, 248, 0.25)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor =
                ...
                <div className="space-y-8">
                  ...
                  >
                    <div
                      ...
                      style={{ backgroundColor: "rgba(123, 123, 123, 0.2)" }}
                    >
                      <MapPin
                        className="w-6 h-6"
                        style={{ color: "#F8F8F8" }}
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mb-1" style={{ color: "#7B7B7B" }}>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mb-1" style={{ color: "#7B7B7B" }}>
                        {contactInfo.chatToUs.description}
                      </p>
                      <a
                    ...
                    <div className="flex gap-4">
                      {contactInfo.socialMedia.map((social) => (
                        <a
                          ...
                          className="p-4 backdrop-blur-md rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 group/social"
                          style={{
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onFocus={(e) => {
                        e.target.style.borderColor = "rgba(248, 248, 248, 0.4)";
                        e.target.style.backgroundColor =
                          "rgba(248, 248, 248, 0.15)";
                      }}
                      onBlur={(e) => {
                  ...
                  <div
                    ...
                    style={{ backgroundColor: "rgba(248, 248, 248, 0.05)" }}
                  >
                    <input
                      type="checkbox"
                      id="agreePrivacy"
                  ...
                  <button
                    ...
                    onMouseLeave={(e) => {
                      e.target.style.backgroundColor =
                        "rgba(248, 248, 248, 0.2)";
                      e.target.style.borderColor = "rgba(248, 248, 248, 0.3)";
                    }}
                  >
