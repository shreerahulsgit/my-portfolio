...
import { Award, Code, Database, Cloud, Network, Zap, Sparkles } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl sm:text-2xl text-gray-400 max-w-3xl mx-auto">
                            A journey of continuous growth through
                            industry-recognized certifications and hands-on
                            training
                        </p>
                    </motion.div>
                </div>
                                ...
                                {mainCertifications.map((cert, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 
                                      ...
                                      shadow-2xl ${cert.glow} hover:shadow-2xl overflow-hidden`}
                                        ...
                                        group-hover:opacity-20 transition-opacity duration-500`}
                                          ...
                                          flex items-center justify-center mb-6 shadow-lg`}
                                                    ...
                                                    <h3
                                                        className="text-2xl font-bold mb-2 text-white group-hover:text-transparent 
                                         ...
                                         group-hover:bg-clip-text transition-all"
                                                ...
                                                {/* Corner accent */}
                                                <div
                                                    className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${cert.color} 
                    ...
                    >
                        <div className="md:grid md:grid-cols-2 md:gap-8 items-center">
                            ...
                            <div className="md:text-right md:pr-12">
                                <h2
                                    className="text-4xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 
                               bg-clip-text text-transparent"
                                >
                                    Training Courses
                                </h2>
                                <p className="text-gray-400 mb-8">
                                    Comprehensive development programs from
                                    NxtWave
                                </p>
                            </div>
                                 ...
                                 transition-all duration-300 group cursor-pointer"
                                        >
                                            <div className="flex items-center gap-4">
                                                <div
                                                    className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 
                    ...
                    >
                        <div className="md:grid md:grid-cols-2 md:gap-8 items-center">
                            ...
                            <div className="md:pl-12 order-1 md:order-2 mb-8 md:mb-0">
                                <h2
                                    className="text-4xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 
                               bg-clip-text text-transparent"
                                >
