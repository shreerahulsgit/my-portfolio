...
const NavigationBar = ({
  ...
  return (
    ...
    >
      <div
        className="relative bg-white/6 backdrop-blur-xl rounded-2xl px-6 py-3 border border-white/10 shadow-2xl"
        style={{
            ...
            return (
              <div key={index} className="relative">
                <button
                  ...
                  className={`relative transition-all duration-300 group outline-none border-none focus:outline-none ${
                    isSpecial ? "p-3 rounded-xl" : "p-3 rounded-xl"
                  }`}
