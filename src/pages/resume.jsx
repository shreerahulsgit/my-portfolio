                ...
                <div className="flex justify-center items-center gap-2 mt-3">
                  <Eye
                    className={`w-4 h-4 transition-all duration-300 drop-shadow-md ${
                      isHovering ? "scale-125 text-white" : "text-white/70"
                    }`}
                  />
        ...
        >
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              >
                <Download className="w-5 h-5 transition-transform duration-300 group-hover:translate-y-0.5 group-hover:scale-90 drop-shadow-md" />
                <span className="drop-shadow-md">Download Resume</span>
              </button>
            </div>
