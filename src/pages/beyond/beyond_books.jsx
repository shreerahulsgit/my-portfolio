...
export default function BooksShelf() {
  ...
  const isOutroVisible = scrollY > 2000;
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-x-hidden">
      ...
      <header className="relative z-10 text-center pt-20 pb-16 px-4">
        ...
        <h1
          className="text-5xl md:text-7xl lg:text-8xl font-thin text-white tracking-tight mb-6 animate-fadeIn"
        ...
        >
          A curated collection of stories that transformed my perspective on
      ...
      >
        <div className="text-center space-y-10 max-w-5xl relative">
          ...
          <div className="relative space-y-8">
            ...
            <h3 className="text-3xl md:text-5xl lg:text-6xl font-thin text-white leading-[1.3] tracking-tight">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl italic text-gray-300 font-light leading-relaxed">
