  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        description: "Creating blueprint layouts for user interface structure.",
        fluency: 85,
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Android",
        icon: SiAndroid,
        description: "Open-source mobile OS powering billions of devices.",
        fluency: 78,
      ...
      },
      {
        name: "iOS",
        icon: SiApple,
        description: "Apple's mobile operating system for iPhone and iPad.",
        fluency: 70,
      ...
      },
      {
        name: "Linux",
        icon: SiLinux,
        description: "Open-source Unix-like OS for servers and development.",
        fluency: 80,
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Hover over each skill to see proficiency levels and click to explore
